...
/*
        ...
        film_adlari.add("Star Wars");
        film_turleri.add("Bilim Kurgu");
        film_sureleri.add(165);

        film_adlari.add("Interstaller");
        film_turleri.add("Bilim Kurgu");
        film_sureleri.add(154);
*/
        while (true) {
